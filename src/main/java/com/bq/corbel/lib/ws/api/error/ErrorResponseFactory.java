package com.bq.corbel.lib.ws.api.error;
...
public class ErrorResponseFactory {
	...
	private static final com.bq.corbel.lib.ws.model.Error DEFAULT_FORBIDDEN_ERROR = new Error("forbidden", ErrorMessage.FORBIDDEN.getMessage());
